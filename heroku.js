    ...
    function getCurrentTimeUTC()
{
  ...
  return temp.toLowerCase();
    ...
    "ops":[
    {
        ...
        var Signature = '';
        var GMT_UNIXTIME = getCurrentTimeUTC();
        var API_SECRET = 'BqA0JT0eEGI9Rc8gDqD5dh7GpefoG9t2JLCUoqriGV1PyYovAi';
		var CONTENT = paramsinjson;
  
  Signature = Signature.concat(GMT_UNIXTIME, API_SECRET, CONTENT, API_SECRET);
  Signature = SHA1(Signature);
  Signature = Signature.toString(16);
 
var url =  'https://www.corezoid.com/api/1/json/86712/';
url = url.concat(GMT_UNIXTIME,'/',Signature);
xmlhttp = new XMLHttpRequest();
xmlhttp.open('POST', url, true);
xmlhttp.setRequestHeader("Content-type", "application/json; charset=utf8");
  
//dataobj = dataobj.concat('',paramsinjson);
xmlhttp.send(paramsinjson);
